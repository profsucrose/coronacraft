...
public class HDTest implements CommandExecutor {
    ...
    static private void loadStreams(CommandSender sender) {
        ...
        // -192 4 319
            ...
            try {
                URL streamCaptureDownload = new URL("https://firestore.googleapis.com/v1/projects/coronacraft-0/databases/(default)/documents/videostreams/one");
